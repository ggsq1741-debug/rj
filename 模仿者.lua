...
-- ==================== 自定义三角洲行动风格主题 ====================
local techGreen = Color3.fromRGB(0, 255, 65)
...
local Tabs = {
    ...
    zho = Window:Tab({ Title = "模仿者", Icon = sjzIcon }),
}
...
张怀民不是民😛😋！
    ...
    IsLoadFinish = true,
    GroupNum = "1040209982" -- 复制按钮读取的群号，不能少
}
...
-- 创建分区，所有按钮/开关统一用这个
local zhoSection = Tabs.zho:Section({
    Title = "功能面板",
    Collapsible = false,
    DefaultOpen = true
})
-- ==================== 传送点位按钮（全部替换TabHandles.Q → zhoSection） ====================
zhoSection:Button({
    Title = "提示",
    Desc = "第一关卡在日本屋子里",
    Image = "palette",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1675.27, -23.32, -3411.01)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1562.39,  -29.25,  -3403.67)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1524.21,  -29.25,  -3580.63)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1642.97,  -23.44,  -3434.15)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1680.65,  -23.47,  -3391.97)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1620.64,  -23.44,  -3397.37)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -1531.34, -30.17,  -3541.97)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( 578.31,  567.98,  -380.59)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( 3837.46,  137.13,  12.84)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
zhoSection:Button({
    ...
    Callback = function()
        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( 343.48,  20.66,  3608.81)
        end
        WindUI:Notify({
            Title = "通知",
            Content = "加载成功",
...
-- ==================== ESP开关（全部替换TabHandles.W → zhoSection） ====================
zhoSection:Toggle({
    Title = "透视开启",
    Value = false,
